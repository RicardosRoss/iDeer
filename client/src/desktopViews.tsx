        ...
        {activeTab === "subscriptions" ? <section className="control-section">
          <details className="secondary-section">
            ...
            <div className="secondary-section__body">
              ...
              <div className="form-grid two"><label className="form-field"><span>{props.copy.settings.rssUrls}</span><input value={props.config.rss_urls} onChange={(event) => set("rss_urls", event.target.value)} /></label><label className="form-field"><span>{props.copy.settings.rssMaxItems}</span><input type="number" value={props.config.rss_max_items} onChange={(event) => set("rss_max_items", Number(event.target.value))} /></label></div>
